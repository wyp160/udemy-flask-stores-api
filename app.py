...
# database
app.config['SQLALCHEMY_DATABASE_URI'] = os.environ.get('DATABASE_URL', 'sqlite:///' + 'data.db').replace('postgres://', 'postgresql://')  # use os env var or default: 'sqlite:///' + 'data.db'
...
if __name__ == '__main__':  # will not run this if this file is imported.
    # will not run in clound env like heroku
